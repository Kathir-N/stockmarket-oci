...
public interface StockRepository extends JpaRepository<Stock, Long> {
	...
	@Query(nativeQuery = true, value = "select stock_price from stock s where s.company_code=:company_code ORDER BY stock_date DESC LIMIT 1")
	...
	public List<Stock> findByDateandDate(@Param("company_code") long id ,@Param(value = "stock_date") LocalDate startDate,@Param(value = "stock_date")  LocalDate endDate);
